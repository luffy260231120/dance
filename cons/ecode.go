...
// 牛方案1.0错误码
const (
	ERR_SSO1_SYSTEM        = 100001
	ERR_SSO1_LICENSE_USED  = 100113
	ERR_SSO1_LICENSE_EARLY = 100114
	ERR_SSO1_LICENSE_NUM   = 100115
)
...
const (
	...
	ERR_BT_GID       = 40200
	ERR_BT_PID       = 40201
	ERR_BT_TIMESTAMP = 40202
	ERR_BT_PUBKEY    = 40203
	ERR_BT_SIGN      = 40204
)

const (
	ERR_PUB_UNKOWN = 200000 //位置错误
...
const (
	ERR_CODE_EXPIRE   = 200100
	ERR_CODE_NOTSTART = 200101
	ERR_CODE_USED     = 200102
	ERR_CODE_NOTEXIST = 200103
)

const (
	ERR_VIP_NOCODE = 200200
)

const (
	ERR_QR_NOSCAN = 200300
	ERR_QR_CANCEL = 200301
	ERR_QR_EXPIRE = 200302
	ERR_QR_FAILED = 200303
)

const (
	ERR_VERIFY_CODE_EXPIRE  = 200401
	ERR_VERIFY_CODE_INVALID = 200402
)

const (
	ERR_EXCEED_USE_TIME = 200501
)

const (
	ECODE_UP_MULTI_ACCOUNT = 34175
)

const (
	SEARCH_NO_DATA = 102005
)
